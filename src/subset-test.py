...
samples_per_class_test = 235 // num_classes  # Contoh: set 750 sampel untuk data uji
...
if len(balanced_test_data) > 235:
    balanced_test_data = balanced_test_data.sample(235)
